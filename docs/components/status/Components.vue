<template>
  <div class="component-status">
    <ul class="status-list">
      <li>
        <fn1-icon name="ready" fill="#7cb518" size="small" />
        <p>Ready</p>
      </li>
      <li>
        <fn1-icon name="review" :fill="tokens.color_ucla_gold.value" size="small" />
        <p>Under review</p>
      </li>
      <li>
        <fn1-icon name="deprecated" :fill="tokens.color_vermilion.value" size="small" />
        <p>Deprecated</p>
      </li>
      <li>
        <fn1-icon name="prototype" :fill="tokens.color_bleu_de_france.value" size="small" />
        <p>Prototype</p>
      </li>
      <li>
        <span>—</span>
